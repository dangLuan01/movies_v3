    ...
    <div class="hero common-hero">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="hero-ct">
                        <h1> {{ $cast_slug->title }}</h1>
                        <ul class="breadcumb">
                            <li class="active"><a href="#">Home</a></li>
                            <li> <span class="ion-ios-arrow-right"></span> Phim theo diễn viên {{ $cast_slug->title }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row ipad-width">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="flex-wrap-movielist">
                        @foreach($movie_cate_with_ratings as $movie)
                    ...
                    {{ $movies_cast->links('vendor.pagination.custom') }}
                    </div>
                </div>
