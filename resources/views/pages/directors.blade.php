    ...
    <div class="hero common-hero">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="hero-ct">
                        <h1> {{ $directors_slug->name }}</h1>
                        <ul class="breadcumb">
                            <li class="active"><a href="#">Home</a></li>
                            <li> <span class="ion-ios-arrow-right"></span> Phim theo đạo diễn {{ $directors_slug->name }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row ipad-width">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="flex-wrap-movielist">
                        @foreach($movie_directors_with_ratings as $movie)
