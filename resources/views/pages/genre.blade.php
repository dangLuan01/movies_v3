    ...
    <div class="hero common-hero">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="hero-ct">
                        <h1> {{ $gen_slug->title }}</h1>
                        <ul class="breadcumb">
                            <li class="active"><a href="#">Home</a></li>
                            <li> <span class="ion-ios-arrow-right"></span> Danh sách phim {{ $gen_slug->title }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row ipad-width">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="flex-wrap-movielist">
                        @foreach($movie_genre_with_ratings as $movie)
                    ...
                    {{ $movie_genre->links('vendor.pagination.custom') }}
                    </div>
                </div>
