        ...
        <div class="row">
            ...
            <div class="slick-multiItemSlider">
                ...
                <div class="movie-item">
                    ...
                    <div class="title-in">
                        <div class="cate">
                            <span class="blue"><a href="#">@foreach($h->movie_genre as $genre)
                                    {{ $genre->title }}
                                @endforeach</a></span>
                        </div>
                        ...
                        <p><i class="ion-android-star"></i><span>
                                @php
                                $api_imdb = Http::get('https://www.omdbapi.com/?i=' . $h->imdb . '&apikey=6c2f1ca1');
                                        ...
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                ...
                                                @if ($image_check == 'https') {{ $url_update . $image }}
                                                    ...
                                                    alt="{{ $movie->title }}" width="185" height="284" style="width: 185px; height:230px;" loading="lazy">
                                            </div>
                                            <div class="hvr-inner">
                ...
                <div class="tabs">
                    <div class="tab-content">
                        <div id="tab22" class="tab active" >
                            <div class="row">
                                <div class="slick-multiItem">
                                    @foreach($movie_animation as $movie)
